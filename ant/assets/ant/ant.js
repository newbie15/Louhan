$(document).ready(function(){
        	...
        	for (var i = 0; i < data.length; i++) {
	            ...
	            <table>\
	            	...
	            	<tr>\
	            		...
	            		<td><input onchange=\"updatevalue(this)\" name=\"start-"+ autonum +"\" type=\"text\" value=\""+x[4]+"\"></td>\
	            	</tr>\
	            	<tr>\
	            		<td><strong>Stop</strong></td>\
	            		<td><input onchange=\"updatevalue(this)\" name=\"stop-"+ autonum +"\" type=\"text\" value=\""+x[5]+"\"></td>\
	            	</tr>\
	            	<tr>\
    ...
    $("#my-spreadsheet").click(function(e){
    	if($(e.target).hasClass('hapus')){
	        confirm("Yakin menghapus Job ini ?", function(done) {
	            if (!done) {
    ...
    $("#simpanjob").click(function(){
        ...
        <table>\
        	...
        	<tr>\
        		<td><strong>Start</strong></td>\
        		<td><input onchange=\"updatevalue(this)\" name=\"start-"+ autonum +"\" type=\"text\" value=\""+start+"\"></td>\
        	</tr>\
        	<tr>\
        		<td><strong>Stop</strong></td>\
        		<td><input onchange=\"updatevalue(this)\" name=\"stop-"+ autonum +"\" type=\"text\" value=\""+stop+"\"></td>\
        	</tr>\
        	<tr>\
        		<td><strong>Status</strong></td>\
        		<td>\
