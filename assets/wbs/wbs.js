        	...
        	for (var i = 0; i < data.length; i++) {
	            ...
	            <table>\
                    ...
                    <tr>\
                        ...
                        <td>"+x[0]+"<input type=\"hidden\" id=\"project_id-"+ autonum +"\" name=\"project_id-"+ autonum +"\" value=\""+x[0]+"\"></td>\
                    </tr>\
	            	<tr>\
	            		<td><strong>PT</strong></td>\
	            		<td>"+x[1]+"<input type=\"hidden\" id=\"pt-"+ autonum +"\" name=\"pt-"+ autonum +"\" value=\""+ x[1] +"\"></td>\
	            	</tr>\
	            	<tr>\
	            		<td><strong>Proyek</strong></td>\
	            		<td>"+x[2]+"<input type=\"hidden\" id=\"nama-"+ autonum +"\" name=\"nama-"+ autonum +"\" value=\""+x[2]+"\"></td>\
	            	</tr>\
	            	<tr>\
	            		<td><strong>Aktifitas</strong></td>\
	            		<td>\
                            <select id=\"activity-"+ autonum +"\" name=\"activity-"+ autonum +"\">";
                x[3] == "marking" ? a = "<option selected=\"selected\">marking</option>" : a = "<option>marking</option>"
                x[3] == "cutting" ? b = "<option selected=\"selected\">cutting</option>" : b = "<option>cutting</option>"
                x[3] == "machining" ? c = "<option selected=\"selected\">machining</option>" : c = "<option>machining</option>"
                x[3] == "assembly" ? d = "<option selected=\"selected\">assembly</option>" : d = "<option>assembly</option>"
                x[3] == "welding" ? e = "<option selected=\"selected\">welding</option>" : e = "<option>welding</option>"
                x[3] == "painting" ? f = "<option selected=\"selected\">painting</option>" : f = "<option>painting</option>"
                x[3] == "balancing" ? g = "<option selected=\"selected\">balancing</option>" : g = "<option>balancing</option>"
                x[3] == "finishing" ? h = "<option selected=\"selected\">finishing</option>" : h = "<option>finishing</option>"
                x[3] == "installing" ? i = "<option selected=\"selected\">installing</option>" : i = "<option>installing</option>"
                x[3] == "Pilih Salah Satu" ? z = "<option selected=\"selected\">Pilih Salah Satu</option>" : z = "<option>Pilih Salah Satu</option>"
                ...
                shtml += "</select>"+
                    ...
                    <tr>\
                        ...
                        <td><input type=\"text\" id=\"keterangan-"+ autonum +"\" name=\"keterangan-"+ autonum +"\" value=\""+x[4]+"\"></td>\
                    </tr>\
	            	<tr>\
	            		<td><strong>Start</strong></td>\
	            		<td><input onchange=\"updatevalue(this)\" name=\"start-"+ autonum +"\" type=\"time\" value=\""+x[5]+"\"></td>\
	            	</tr>\
	            	<tr>\
	            		<td><strong>Stop</strong></td>\
	            		<td><input onchange=\"updatevalue(this)\" name=\"stop-"+ autonum +"\" type=\"time\" value=\""+x[6]+"\"></td>\
	            	</tr>\
